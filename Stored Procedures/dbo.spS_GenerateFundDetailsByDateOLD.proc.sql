...
SELECT	RawData.FundId,
	...
	CASE
		...
		WHEN RawData.SecurityType in ('Cash','CashOft','Future Offset', 'FX', 'MMFunds', 'CD') THEN 0
	...
	dbo.fn_GetBaseCCYPrice(
		(CASE WHEN RawData.SecurityType in ('IntRateFut')
	...
	, RawData.UnderMult
	, RawData.Strike
	, UnderPrice = 	(CASE WHEN RawData.SecurityType in ('IntRateFut', 'IntRateOpt') THEN 1

...
IF  EXISTS (
	...
	WHERE 	id = OBJECT_ID(N'[dbo].[spS_HFLimitsCheck_V2]') AND 
		OBJECTPROPERTY(id,N'IsProcedure') = 1
	)
DROP PROCEDURE [dbo].[spS_HFLimitsCheck_V2]
GO

CREATE PROCEDURE [dbo].[spS_HFLimitsCheck_V2] 
	@RefDate datetime	
	, @FundId integer
AS
...
EXEC spS_HedgeFundsReport_V2 @RefDate, @FundId

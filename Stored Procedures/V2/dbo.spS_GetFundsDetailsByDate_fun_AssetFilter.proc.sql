...
IF  EXISTS (
	...
	WHERE 	id = OBJECT_ID(N'dbo.spS_GetFundsDetailsByDateAF_V2') AND 
		OBJECTPROPERTY(id,N'IsProcedure') = 1
	)
DROP PROCEDURE dbo.spS_GetFundsDetailsByDateAF_V2
GO

CREATE PROCEDURE dbo.spS_GetFundsDetailsByDateAF_V2
	@RefDate datetime
	, @FundId int
	, @PercDayVol float
...
GO
----------------------------------------------------------------------------------
GRANT EXECUTE ON dbo.spS_GetFundsDetailsByDateAF_V2 TO [OMAM\StephaneD], [OMAM\MargaretA] 

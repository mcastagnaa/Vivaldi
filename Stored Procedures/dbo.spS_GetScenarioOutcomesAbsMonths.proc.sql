...
IF  EXISTS (
	...
	WHERE 	id = OBJECT_ID(N'[dbo].[spS_GetScenarioOutcomesAbsMonths]') AND 
		OBJECTPROPERTY(id,N'IsProcedure') = 1
	)
DROP PROCEDURE [dbo].[spS_GetScenarioOutcomesAbsMonths]
GO

CREATE PROCEDURE [dbo].[spS_GetScenarioOutcomesAbsMonths] 
	@RefDate datetime,
	@FundId int,
	@Months int
AS
...
GRANT EXECUTE ON spS_GetScenarioOutcomesAbsMonths TO [OMAM\StephaneD]
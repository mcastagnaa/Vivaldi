...
SELECT * FROM #FactorsW
ORDER BY FundId, SecurityType, BBGTicker
----------------------------------------------------------------------------------
...
----------------------------------------------------------------------------------
--GRANT EXECUTE ON dbo.spS_GetFundsDetailsAndRiskByDate_V2 TO [OMAM\StephaneD], [OMAM\MargaretA]
...
IF  EXISTS (
	...
	WHERE 	id = OBJECT_ID(N'[dbo].[spS_GetScenOutcomesAbsLbck]') AND 
		OBJECTPROPERTY(id,N'IsProcedure') = 1
	)
DROP PROCEDURE [dbo].[spS_GetScenOutcomesAbsLbck]
GO

CREATE PROCEDURE [dbo].[spS_GetScenOutcomesAbsLbck] 
	@RefDate datetime
	, @FundId int
	, @Lbck int
AS
...
GRANT EXECUTE ON spS_GetScenOutcomesAbsLbck TO [OMAM\StephaneD]